...
from alpespartners.modulos.comision_recompensa.infraestructura.schema.v1.eventos import EventoReservaCreada
from alpespartners.modulos.comision_recompensa.infraestructura.schema.v1.comandos import ComandoCrearReserva
