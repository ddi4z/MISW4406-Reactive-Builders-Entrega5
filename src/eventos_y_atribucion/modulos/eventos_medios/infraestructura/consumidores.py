...
from eventos_y_atribucion.modulos.eventos_medios.infraestructura.schema.v1.eventos import EventoReservaCreada
from eventos_y_atribucion.modulos.eventos_medios.infraestructura.schema.v1.comandos import ComandoCrearReserva
