from aeroalpes.modulos.externo.aplicacion.comandos.crear_evento import CrearEvento
...
from aeroalpes.modulos.externo.aplicacion.mapeadores import MapeadorEventoDTOJson
